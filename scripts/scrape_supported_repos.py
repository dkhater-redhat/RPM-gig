...
URL = "https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html-single/package_manifest/index"
...
if baseos_df is not None:
    baseos_df.to_csv("rhel10_baseos_packages.csv", index=False)
if appstream_df is not None:
    appstream_df.to_csv("rhel10_appstream_packages.csv", index=False)
